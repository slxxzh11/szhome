...
public class BBSListDlDAO {
	
	List<String> m_ListUrl;
	
	private static BBSListDlDAO  s_inst = null;
	  
	private BBSListDlDAO(){
	       
	}
	 
	 public static BBSListDlDAO getInstance(){
	       if (s_inst == null){
	    	   s_inst = new BBSListDlDAO();
	       }
	       return s_inst;
	 }
	 ...
	 {
		 synchronized(m_ListUrl)
		 {
			 m_ListUrl.add(strUrl);
		 }
		 return true;		 
	 }
